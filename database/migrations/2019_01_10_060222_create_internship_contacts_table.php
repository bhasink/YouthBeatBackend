...
class CreateInternshipContactsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('internship_contacts', function (Blueprint $table) {
            ...
            $table->text('additional_answer_1')->nullable();
            $table->text('additional_answer_2')->nullable();
            $table->text('additional_answer_3')->nullable();
            $table->text('additional_answer_4')->nullable();
            $table->text('additional_answer_5')->nullable();
